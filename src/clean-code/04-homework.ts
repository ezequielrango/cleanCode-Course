...
(() => {
    ...
    // isRedFruit
    console.log({ isRedFruit2: isRedFruit2('cereza'), fruit: 'cereza' }); // true
    console.log({ isRedFruit2: isRedFruit2('piña'), fruit: 'piña' }); // true
    ...
    // workingSteps2
    console.log({ workingSteps2: workingSteps2() }); // Cambiar los valores de la línea 31 y esperar los resultados
